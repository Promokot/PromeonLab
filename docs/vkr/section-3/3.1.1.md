...
> Статус: ПРИНЯТ Максом (2026-06-04); 2026-06-04 – стилистическая чистка по правилу 5.12, восстановлен обрезанный синхронизацией хвост файла; 2026-06-05 – восстановлен оборванный синхронизацией хвост последнего абзаца, затем финальная лаконичная редакция Макса: финал слит с абзацем об асинхронном доступе, переходная фраза к 3.1.2 снята.
> Нумерация сквозная в пределах раздела 3, реестр: numbering-registry.md.

Все перечисленные данные размещаются в локальном хранилище устройства, в каталоге Application.persistentDataPath. На VR-гарнитуре под управлением Android это внутреннее хранилище приложения, при запуске в редакторе Unity – служебная папка профиля пользователя. Подключение к персональному компьютеру или внешним системам не требуется, чем обеспечивается полная автономность приложения.
