...
Описанная организация отвечает на вопрос, где располагаются данные приложения. Не менее важно внутреннее устройство самих данных – записей ассетов, сцен и анимаций.
