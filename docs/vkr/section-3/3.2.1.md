...
> Статус: ПРИНЯТ Максом (2026-06-04, финальная редакция Макса после ревью). История правок и решений: plan-3.2.md (решения 12–15). Дополнение 2026-06-05 (решение Макса): вставлен Рисунок 3.6 (виды сцен трёх режимов), последующие рисунки сдвинуты на +1.
