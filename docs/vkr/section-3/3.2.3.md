...
> Статус: ПРИНЯТ Максом (2026-06-05, финальная редакция Макса: оговорка о незадействованном родительстве перенесена в абзац загрузки, дубль у обозревателя снят). История решений 1–12: plan-3.2.3.md.
