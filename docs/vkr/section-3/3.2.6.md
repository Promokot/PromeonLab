...
> Статус: ПРИНЯТ (2026-06-05, финальная редакция Макса: в финальном абзаце снята адресная отсылка к 3.2.7 – пункт закрывается контуром редактирования). План и история решений: plan-3.2.6.md.
> Нумерация сквозная в пределах раздела 3, реестр: numbering-registry.md. Писался с плейсхолдерами 3.В-N/Б.В-N параллельно с 3.2.5; после приёмки обоих присвоены реальные номера: Листинги 3.48–3.56, Рисунки 3.17–3.19, Б.22–Б.28.
> Скриншоты Рисунков 3.17–3.19 – за Максом. ⚠ Сверить при съёмке: Рисунок 3.16 (3.2.5, «режим костей, одна кость выделена») и Рисунок 3.19 (выделенная кость) – возможный дубль сюжета.
